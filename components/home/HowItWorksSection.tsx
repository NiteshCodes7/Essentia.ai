...
const steps : Step[] = [
    ...
    },
    {
        ...
        label: "AI Analysis",
        description: "Our advanced AI processes and analysis your document instantly",
    },
    {
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative'>
            {steps.map((step, index) => (
                <div key={index} className='relative flex items-center'>
                    <StepItem {...step} />
                    <div className='hidden md:flex h-full items-center transform translate-y-1 z-10'>
                        {index < steps.length - 1 && <MoveRight size={32} strokeWidth={1} className='text-rose-400' />}
