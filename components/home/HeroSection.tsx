...
const HeroSection = () => {
  return (
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-12 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl h-screen">
      <div className="">
